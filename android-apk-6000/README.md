# 國高中英文 6000 單字王 APK 打包說明

這個目錄是 6000 單字 Android WebView 離線版，會載入 `app/src/main/assets/index.html`。
...
每次修改根目錄的 `eng6000/index.html` 後，重新複製到：

```powershell
Copy-Item ..\eng6000\index.html .\app\src\main\assets\index.html -Force
```
